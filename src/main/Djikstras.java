...
public class Djikstras {
	...
	public static void main(String[] args) {
		Graph g = new Graph();
		g.addVertex('A', Arrays.asList(new Vertex('B', 3), new Vertex('C', 4), new Vertex('D', 6)));
		g.addVertex('B', Arrays.asList(new Vertex('A', 3), new Vertex('C', 1), new Vertex('D', 7)));
		g.addVertex('C', Arrays.asList(new Vertex('A', 4), new Vertex('B', 1), new Vertex('D', 8)));
		g.addVertex('D', Arrays.asList(new Vertex('A', 6), new Vertex('B', 6), new Vertex('C', 7)));
		...
		System.out.println(g.getShortestPath('A', 'D'));
	}
